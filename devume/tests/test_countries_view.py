...
class CountriesViewTestCase(APITestCase):
    ...
    def test_create_country(self):
        ...
        response = self.client.post('/api/countries/create', country_data, format='json', headers=headers)
    ...
    def test_update_country(self):
        ...
        response = self.client.patch(f'/api/countries/{self.country.id}/update', country_data, format='json', headers=headers)
        self.assertEqual(response.status_code, 200)
