...
from devume.views.profiles_view import (
    ProfileRetrieveView,
    ProfileCreateView,
    ProfileUpdateView,
    ProfileListView,
...
from devume.views.cities_view import (
    CitiesListView,
    CitiesCreateView,
    CitiesRetrieveView,
    CitiesUpdateView,
)
from devume.views.countries_view import (
    CountriesCreateView,
    CountriesListView,
    CountriesRetrieveView,
    CountriesUpdateView,
)
from devume.views.states_view import (
    StatesCreateView,
    StatesListView,
    StatesRetrieveView,
    StatesUpdateView,
)
from devume.views.work_experience_view import (
...
from devume.views.skills_view import (
    SkillListView,
    SkillCreateView,
    SkillRetrieveView,
    SkillUpdateView,
...
urlpatterns = [
    ...
    path(
        ...
        name="cities_retrieve",
    ),
    path(
        "api/cities/<int:pk>/update",
        CitiesUpdateView.as_view(),
        name="cities_update",
    ),
    path("api/countries", CountriesListView.as_view(), name="countries_list"),
    path(
        "api/countries/<int:pk>",
        CountriesRetrieveView.as_view(),
        name="countries_retrieve",
    ),
    path(
        "api/countries/create",
        CountriesCreateView.as_view(),
        name="countries_create",
    ),
    path(
        "api/countries/<int:pk>/update",
        CountriesUpdateView.as_view(),
    ...
    path(
        "api/work_experience/<uuid:profile_id>",
        WorkExperienceRetrieveView.as_view(),
        name="work_experience_retrieve",
    ),
    path(
    ...
    path(
        "api/work_experience/<int:pk>/update",
    ...
    path(
        ...
        EducationRetrieveView.as_view(),
        name="education_retrieve",
    ),
    path(
        "api/education/<int:pk>/update",
    ...
    path(
        "api/skills/<int:pk>",
        SkillRetrieveView.as_view(),
        name="skill_retrieve",
    ),
    path(
        "api/skills/<int:pk>/update",
